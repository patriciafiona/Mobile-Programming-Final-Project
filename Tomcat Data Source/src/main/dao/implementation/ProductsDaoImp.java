...
public class ProductsDaoImp implements Dao{
	...
	public <Product> List<Product> findAll() throws SQLException {
		...
		String sql = "SELECT products.id, products.name, products.price, products.description, "
		...
		while (rs.next()) {
			...
			main.entities.Product product = new main.entities.Product(id, name, price, description, rating, style, color_description,
	...
	public <Product> Product findById(int id) throws SQLException {
		...
		if (rs.next()) {
			...
			product = new main.entities.Product(res_id, name, price, description, rating, style, color_description,
					stocks, photo_01, photo_02, photo_03, photo_04, photo_05, categories_name, color_code);
		}
		JDBCUtil.close(conn, st, rs);
	...
	public <Product> List<Product> findByName(String name) throws SQLException {
		...
		while (rs.next()) {
			...
			main.entities.Product product = new main.entities.Product(id, res_name, price, description, rating, style, color_description,
					stocks, photo_01, photo_02, photo_03, photo_04, photo_05, categories_name, color_code);
			products.add(product);
		}
		JDBCUtil.close(conn, st, rs);
