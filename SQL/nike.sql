...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2021 at 02:07 AM
...
(18, 1, 1, 'Nike Air Force 1 \'07 LV8', 1499000, 'CELEBRATING 75 YEARS OF HOOPS.\r\n\r\n\r\nFrom the class of \'82, it\'s the ferocious defender of heritage style.In honour of the 75th anniversary of the NBA, put your hands together for a fresh take on the one of the shoes that started it all.Notice the year 1946 all over this Air Force 1?That\'s the year hoops magic began.\r\n\r\n\r\nBenefits\r\n\r\n- Leather on the upper.\r\n- Classic colours nod to legendary hoops teams.\r\n- Originally designed for performance hoops, the Air cushioning delivers lasting comfort.\r\n- Details include metal dubraes with \"1946\" and \"2021\", a woven tongue label and embroidered logos.\r\n\r\nProduct Details\r\n\r\n- Metal Swoosh on U-throat\r\n- Padded ankle and tongue\r\n- Perforations on the toe\r\n- Embroidered Swoosh on heel\r\n- Rubber outsole\r\n- Country/Region of Origin: Vietnam\r\n\r\nAir Force 1 Origins\r\n\r\nDebuting in 1982, the AF-1 was the first basketball shoe to house Nike Air, revolutionising the game while rapidly gaining traction around the world.Today, the Air Force 1 stays true to its roots with the same soft and springy cushioning that changed sneaker history.'),
(19, 1, 1, 'Nike Air Pegasus 83 Premium', 1429000, 'RETRO RUNNING STYLE.\r\n\r\n\r\nJust lace up and arrive looking fresh.With a splash of running history, a dash of retro style and a whole lot of comfort, the Nike Air Pegasus 83 Premium is your go-to staple.Era-echoing suedes and durable textile keep it easy to wear.Plush padding and crisp leather around the ankle keep it feeling like your favourite armchair.\r\n\r\n\r\nBenefits\r\n\r\n- Upper features crisp leather accents, luscious suedes and durable textile made for everyday wear.\r\n- Foam midsole with Air unit in the heel delivers lasting comfort.\r\n- Rubber Waffle sole adds traction, durability and heritage style.\r\n- Low-cut, padded collar looks sleek and feels great.\r\n- Country/Region of Origin: Vietnam'),
(20, 1, 1, 'Nike Air Huarache LE', 1799000, 'BRAGGING RIGHTS FOR YOUR FEET.\r\n\r\n\r\nBuilt to fit your foot and designed for comfort, the Nike Air Huarache LE brings back a street-level favourite.Crisp leather on the upper is mixed with super-breathable, perfectly shined neoprene-like fabric for easy styling.The iconic heel clip and stripped away branding keep the early \'90s look you love.\r\n\r\n\r\nBenefits\r\n\r\n- Originally designed for performance running, Nike Air cushioning delivers lasting comfort.\r\n- A plush foam midsole feels soft and springy.\r\n- Iconic heel clip and stripped away branding keep the early-90s look you love.\r\n- Upper has crisp leather and airy, neoprene-like fabric for added comfort and easy styling.\r\n- The cushioned inner sleeve stretches to your foot for a personalised fit.\r\n- The rubber sole adds durability and traction.\r\n\r\nProduct Details\r\n\r\n- Rubber sole\r\n- Variable width lacing\r\n- Huarache emblem on tongue\r\n- Country/Region of Origin: China\r\n\r\nHuarache Origins\r\n\r\nThe Nike Air Huarache released in 1991.Footwear designer Tinker Hatfield wanted to combine the fit of neoprene water-ski boots with the functionality of South American sandals.The instant hit found its way to basketball courts and then the streets, where it earned its status as an icon.');
...
(1, 1, 4.6, 'DJ3624-003', 'Particle Grey/Armoury Navy/Light Bone/Dark Citron', 1, 1283, 10, 'ms0001PG01.png', 'ms0001PG02.png', 'ms0001PG03.png', NULL, NULL, '2021-12-07 07:31:44', '2021-12-07 07:31:44'),
...
(36, 18, 4.6, 'DC8874-101', 'White/Coast/Field Purple/White', 3, 1938, 0, 'ms0006WH01.png', 'ms0006WH02.png', 'ms0006WH03.png', NULL, NULL, '2021-12-16 14:02:13', '2021-12-16 14:02:13'),
(37, 18, 4.6, 'DC8874-001', 'Black/Grey Fog/Sail/Chile Red', 2, 1837, 0, 'ms0006BL01.png', 'ms0006BL02.png', 'ms0006BL03.png', NULL, NULL, '2021-12-16 14:02:13', '2021-12-16 14:02:13'),
(38, 19, 4.1, 'DJ9292-200', 'Khaki/Dark Driftwood/Light Bone/Off-Noir', 15, 2901, 0, 'ms0007KK01.png', 'ms0007KK02.png', 'ms0007KK03.png', NULL, NULL, '2021-12-16 14:05:42', '2021-12-16 14:05:42'),
(40, 20, 4.6, 'DH8143-201', 'Praline/Vine/Black/Umber', 16, 1139, 0, 'ms0008PR01.png', 'ms0008PR02.png', 'ms0008PR03.png', NULL, NULL, '2021-12-16 14:10:56', '2021-12-16 14:10:56'),
(41, 20, 4.8, 'DH8143-200', 'Toadstool/Chestnut Brown/Black', 17, 1928, 0, 'ms0008TD01.png', 'ms0008TD02.png', 'ms0008TD03.png', NULL, NULL, '2021-12-16 14:12:30', '2021-12-16 14:12:30');
...
CREATE TABLE `transactions` (
  ...
  `price` float NOT NULL,
  `total_all_price` double NOT NULL,
  `total_all_product` int(11) NOT NULL,
  `size` int(11) NOT NULL,
  `status_id` int(11) NOT NULL,
  `pay_method` varchar(50) NOT NULL DEFAULT 'CreditCard',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `transactions`
  ...
  ADD CONSTRAINT `transactions_ibfk_4` FOREIGN KEY (`status_id`) REFERENCES `transaction_status` (`id`) ON UPDATE CASCADE;
COMMIT;
